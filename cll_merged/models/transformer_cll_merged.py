...
@dataclass
class EncDecBaseConfigTest(EncDecBaseConfig):
...
@dataclass
class DecoderConfigTest(EncDecBaseConfigTest, DecoderConfig):
    pass


@dataclass
class TransformerConfigTest(TransformerConfig):
    ...
    encoder: EncDecBaseConfigTest = EncDecBaseConfigTest()
    decoder: DecoderConfigTest = DecoderConfigTest()


@register_model("transformer_cll_merged", dataclass=TransformerConfigTest)
