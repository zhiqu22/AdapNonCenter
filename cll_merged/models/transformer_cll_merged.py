...
from cll_merged.models.transformer_encoder_cll_merged import CllMergedTransformerEncoder
from cll_merged.models.transformer_decoder_cll_merged import CllMergedTransformerDecoder
...
@dataclass
class EncDecBaseConfigCllMerged(EncDecBaseConfig):
...
@dataclass
class DecoderConfigCllMerged(EncDecBaseConfigCllMerged, DecoderConfig):
    pass


@dataclass
class TransformerConfigCllMerged(TransformerConfig):
    ...
    encoder: EncDecBaseConfigCllMerged = EncDecBaseConfigCllMerged()
    decoder: DecoderConfigCllMerged = DecoderConfigCllMerged()


@register_model("transformer_cll_merged", dataclass=TransformerConfigCllMerged)
class TransformerModelCllMerged(TransformerModelBase):
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return CllMergedTransformerEncoder(cfg, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return CllMergedTransformerDecoder(
            cfg,
            tgt_dict,
            embed_tokens,
