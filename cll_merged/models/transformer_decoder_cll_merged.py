...
from cll_merged.modules.transformer_layer_cll_merged import CllMergedTransformerDecoderLayer


class CllMergedTransformerDecoder(TransformerDecoderBase):

    def build_decoder_layer(self, cfg, no_encoder_attn=False):
        layer = CllMergedTransformerDecoderLayer(cfg, no_encoder_attn)
