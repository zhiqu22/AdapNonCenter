...
from cll_merged.modules.transformer_layer_cll_merged import CllMergedTransformerEncoderLayer


class CllMergedTransformerEncoder(TransformerEncoderBase):

    def build_encoder_layer(self, cfg):
        layer = CllMergedTransformerEncoderLayer(cfg)
