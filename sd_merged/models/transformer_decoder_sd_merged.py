...
from sd_merged.modules import SdMergedTransformerDecoderLayer
from fairseq.modules import transformer_layer


class SdMergedTransformerDecoder(TransformerDecoderBase):
    def __init__(
        self,
        cfg,
        dictionary,
    ...
    def build_decoder_layer(self, cfg, no_encoder_attn=False, idx=0):
        if idx == 2:
            layer = SdMergedTransformerDecoderLayer(cfg, no_encoder_attn)
        else:
