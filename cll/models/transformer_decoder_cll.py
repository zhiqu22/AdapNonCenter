...
from cll.modules.transformer_layer_cll import TransformerDecoderCll


class CllTransformerDecoder(TransformerDecoderBase):

    def build_decoder_layer(self, cfg, no_encoder_attn=False):
        layer = TransformerDecoderCll(cfg, no_encoder_attn)
