...
from sd.models.transformer_encoder_sd import SdTransformerEncoder
from sd.models.transformer_decoder_sd import SdTransformerDecoder
...
@dataclass
class EncDecBaseConfigSd(EncDecBaseConfig):
...
@dataclass
class DecoderConfigSd(EncDecBaseConfigSd, DecoderConfig):
    pass


@dataclass
class TransformerConfigSd(TransformerConfig):
    ...
    encoder: EncDecBaseConfigSd = EncDecBaseConfigSd()
    decoder: DecoderConfigSd = DecoderConfigSd()


@register_model("transformer_sd", dataclass=TransformerConfigSd)
class TransformerModelSd(TransformerModelBase):
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return SdTransformerEncoder(cfg, src_dict, embed_tokens)
